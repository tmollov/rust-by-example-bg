...
- [Контрол на потока](flow_control.md)
    - [if/else](flow_control/if_else.md)
    - [loop](flow_control/loop.md)
        - [Вложени и етикетирани](flow_control/loop/nested.md)
        - [Връщане от цикли](flow_control/loop/return.md)
    - [while](flow_control/while.md)
    - [for и range](flow_control/for.md)
    - [match](flow_control/match.md)
        - [Деструктуриране](flow_control/match/destructuring.md)
            - [на Tuple](flow_control/match/destructuring/destructure_tuple.md)
            - [на масиви и отрязъци](flow_control/match/destructuring/destructure_slice.md)
            - [на енумерации](flow_control/match/destructuring/destructure_enum.md)
            - [на референции/указатели](flow_control/match/destructuring/destructure_pointers.md)
            - [на структури](flow_control/match/destructuring/destructure_structures.md)
        - [Пазачи](flow_control/match/guard.md)
        - [Присвояване](flow_control/match/binding.md)
